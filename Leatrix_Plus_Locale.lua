...
L["If checked, mechanostriders will be muted."] = "勾选后，静音机械陆行鸟。"
...
L["If checked, mechanostriders will be muted."] = "Si está seleccionado, los mecazancudos serán silenciados."
...
L["Leatrix Plus needs to be updated with the flight details.  Press CTRL/C to copy the flight details below then paste them into a ticket at github.com/leatrix or a message to leatrix via CurseForge website or an email to flight@leatrix.com.  When your report is received, Leatrix Plus will be updated and you will never see this window again for this flight."] = "Leatrix Plus necesita ser actualizado con los detalles del vuelo. Presiona CTRL+C para copiar los detalles del vuelo y luego péguelos en un boleto en github.com/leatrix o envía un mensaje a leatrix a través del sitio web CurseForge o envía un correo electrónico a flight@leatrix.com. Cuando se reciba su informe, Leatrix Plus se actualizará y nunca volverá a ver esta ventana para este vuelo."
